...
recognition.onspeechend = function () {
    recognition.stop();
    var audio = new Audio("https://mrepol742.github.io/audios/transition-base.mp3");
    audio.play();
    status = true;
};
...
async function sendMsg() {
    removetype();
    var audio = new Audio("https://mrepol742.github.io/audios/send.wav");
    audio.play();
...
newchat.addEventListener("click", () => {
    clear();
    var audio = new Audio("https://mrepol742.github.io/audios/reload.mp3");
    audio.play();
});
