...
<html lang="en">
  ...
  <ul class="menu">
        <li class="menuitem" ><a href="#">Rooms</a></li>
        <li class="menuitem" ><a href="#">Pricing</a></li>
        <li class="menuitem" ><a href="#">Tenants</a></li>
        <li class="menuitem" ><a href="#">Amenity</a></li>
</ul>
...
<script>
    ...
    /*
* DO NOT MODIFY this code is use to speed up our system loading and increase performance 
